  ...
  <div class="animated fadeIn">
    <b-card sm="12">
      <b-row>
        ...
        <b-col sm="4">
          <b-form-group
            ...
            :label-cols="3"
            :horizontal="true">
            <b-form-input id="basicText" type="text" placeholder="输入音频名称"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
      ...
      <b-row align-h="center" class="align-items-center mt-4">
        <b-col cols="2">
          <router-link to="/course/new-audio">
            <b-button block variant="outline-primary">新建音频</b-button>
          </router-link>
        </b-col>
        <b-col cols="2">
