    ...
    <b-card sm="12">
      <b-card bg-variant="light">
        <b-row>
          ...
          <b-col>
            <b-row>
              <b-col cols="1">专栏标题</b-col>
              <b-col offset-md="8" cols="3">
                <a class="con-manage" href="#">下架</a>
                <a class="con-manage" href="#">编辑</a>
                <a class="con-manage" href="#">删除</a>
                <a class="con-manage" href="#">停止更新</a>
              </b-col>
            </b-row>
            <b-row class="mt-3">
              <b-col cols="2">¥ 199.00元</b-col>
            </b-row>
            <b-row class="mt-3">
              <b-col cols="2">订阅量：500</b-col>
              <b-col cols="2">内容浏览量：1000</b-col>
              <b-col offset-md="5" cols="3">视频更新数：50（更新中）</b-col>
            </b-row>
          </b-col>
        </b-row>
      </b-card>
        ...
        <b-col>
          <table class="table">
            ...
            <tr v-for="(list, index) in items">
              ...
              <td>{{list.status}}</td>
              <td>{{list.status}}</td>
              <td><a class="operate" href="#">设为试看</a><a class="operate" href="#">编辑</a><a class="operate" href="#">排序</a><a class="operate" href="#">评论</a><a class="operate" href="#">删除</a></td>
            </tr>
          </table>
        </b-col>
      </b-row>
