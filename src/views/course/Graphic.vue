  ...
  <div class="animated fadeIn">
    <b-card sm="12">
      <b-row>
        ...
        <b-col sm="4">
          <b-form-group
            ...
            :label-cols="3"
            :horizontal="true">
            <b-form-input id="basicText" type="text" placeholder=" 输入图文名称"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
      ...
      <b-row align-h="center" class="align-items-center mt-4">
        <b-col cols="2">
          <router-link to="/course/new-graphic">
            <b-button block variant="outline-primary">新建图文</b-button>
          </router-link>
        </b-col>
        <b-col cols="2">
        ...
        <b-col>
          <table class="table">
            ...
            <tr v-for="(list, index) in items">
              ...
              <td>{{list.status}}</td>
              <td>{{list.status}}</td>
              <td><a class="operate" href="#">编辑</a><a class="operate" href="#">下架</a><a class="operate" href="#">评论</a><a class="operate" href="#">删除</a></td>
            </tr>
          </table>
        </b-col>
      </b-row>
  ...
  export default {
    data() {
      return {
        ...
        fields: [
          {key: 'username', label: '图文名称'},
          {key: 'registered', label: '价格'},
          {key: 'role', label: '浏览量'},
          {key: 'status', label: '状态'},
          {key: 'time', label: '上架时间'},
          {key: 'relate', label: '关联专栏'},
