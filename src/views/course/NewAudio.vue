<template>
  <div class="animated fadeIn">
    <b-card sm="12" class="pb-5">
      ...
      <b-row>
        <b-col sm="1">
          <label class="mt-1" for="graphicName">音频名称:</label>
        </b-col>
        <b-col sm="4">
          <b-form-input id="graphicName" type="text" placeholder="请输入音频名称"></b-form-input>
        </b-col>
      </b-row>
      <b-row class="mt-4">
        <b-col sm="1">
