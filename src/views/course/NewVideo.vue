<template>
  <div class="animated fadeIn">
    <b-card sm="12" class="pb-5">
      ...
      <b-row>
        <b-col sm="1">
          <label class="mt-1" for="graphicName">视频名称:</label>
        </b-col>
        <b-col sm="4">
          <b-form-input id="graphicName" type="text" placeholder="请输入视频名称"></b-form-input>
        </b-col>
      </b-row>
      <b-row class="mt-4">
        <b-col sm="1">
          <label class="mt-1">视频上传:</label>
        </b-col>
        <b-col sm="2">
          <b-form-file v-model="file2" plain></b-form-file>
        </b-col>
        <b-col sm="2">格式支持MP4，大小不超过1G</b-col>
      </b-row>
      <b-row class="mt-4">
        <b-col sm="1">
          <label class="mt-1">视频封面:</label>
        </b-col>
        <b-col sm="3">
        ...
        <b-col sm="3">视频封面是指商品列表展示的图片，4:3比例</b-col>
      </b-row>
      <b-row class="mt-4">
        <b-col sm="1">
          <label class="mt-1">视频贴片:</label>
        </b-col>
        <b-col sm="3">
          <b-img src="https://picsum.photos/300/150/?image=41" fluid alt="Fluid image"/>
        </b-col>
        ...
        <b-col sm="3">视频贴片是指视频播放器前展示的图片，16:9比例</b-col>
      </b-row>
      <b-row class="mt-4">
        <b-col sm="1">
          <label class="mt-1">视频详情:</label>
        </b-col>
        <b-col sm="11">
          <quill-editor
            v-model="content"
